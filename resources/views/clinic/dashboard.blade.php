        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card text-white bg-primary">
                ...
                <div class="card-footer bg-primary text-white text-center">
                    <a href="/clinic/consultation?start_date={{ Carbon\Carbon::now()->toDateString() }}&end_date={{ Carbon\Carbon::now()->toDateString() }}" class="btn text-white"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> More Info</a>
                </div>
            </div>
        </div>    
        <div class="col-sm-6 col-lg-3">
            <div class="card text-white bg-success">
                ...
                <div class="card-footer bg-success text-white text-center">
                    <a href="/clinic/consultation?start_date={{ Carbon\Carbon::today()->startOfMonth()->toDateString() }}&end_date={{ Carbon\Carbon::today()->endOfMonth()->toDateString() }}" class="btn text-white"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> More Info</a>
                </div>             
            </div>
        </div>   
        <div class="col-sm-6 col-lg-3">
            <div class="card text-white bg-info">
                ...
                <div class="card-footer bg-info text-white text-center">
                    <a href="/clinic/consultation" class="btn text-white"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> More Info</a>
                </div>  
            </div>
        </div>     
    </div>
            ...
            <table class="table table-bordered table-hover bg-white" id="consultation_table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $consultation->companys_name }}</td>
