        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card text-white bg-primary">
                ...
                <div class="card-footer bg-primary text-white text-center">
                    <a href="/company/consultation?start_date={{ Carbon\Carbon::now()->toDateString() }}&end_date={{ Carbon\Carbon::now()->toDateString() }}" class="btn text-white"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> More Info</a>
                </div>
            </div>
        </div>    
        <div class="col-sm-6 col-lg-3">
            <div class="card text-white bg-success">
                <div class="card-body">
                    <div id="total">
                        <div>{{ $count_monthly_consultation }}</div>
                    </div>
                    <div id="name">
                        <div class="font-weight-bold">Total Monthly Consultation</div>
                    </div>
                </div>  
                <div class="card-footer bg-success text-white text-center">
                    <a href="/company/consultation?start_date={{ Carbon\Carbon::today()->startOfMonth()->toDateString() }}&end_date={{ Carbon\Carbon::today()->endOfMonth()->toDateString() }}" class="btn text-white"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> More Info</a>
                </div>             
            </div>
        </div>
        <div class="col-sm-6 col-lg-3">
            <div class="card text-white bg-info">
                ...
                <div class="card-footer bg-info text-white text-center">
                    <a href="/company/consultation" class="btn text-white"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> More Info</a>
                </div>  
            </div>
        </div>         
        <div class="col-sm-6 col-lg-3 @if($count_total_outstanding == 0) d-none @endif">
            <div class="card text-white bg-warning">
                <div class="card-body">
                    <div id="total">
                        <div>RM {{ $count_total_outstanding }}</div>
                    </div>
                    <div id="name">
                        <div class="font-weight-bold">Total Outstanding</div>
                    </div>
                </div>
                <div class="card-footer bg-warning text-white text-center">
                    <a href="/company/payment" class="btn text-white"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> More Info</a>
                </div>  
            </div>
        </div>        
    </div>
